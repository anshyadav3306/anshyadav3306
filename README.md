...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f0f0f,100:1a1a1a&height=200&section=header&text=anshyadav3306&fontSize=50&fontColor=00FF00&fontAlignY=35&desc=root@github:~$%20whoami&descAlignY=55&descSize=18&descColor=00FF00&animation=fadeIn" width="100%"/>
...
```bash
anshyadav3306@github:~$ cat about.txt
```
